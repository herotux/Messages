...
import org.fossify.messages.helpers.BankLogoThreadCache
...
abstract class BaseConversationsAdapter(
    ...
    private fun setupView(view: View, conversation: Conversation) {
        ItemConversationBinding.bind(view).apply {
            ...
            val bankLogoName = BankLogoThreadCache.get(conversation.threadId)
            val bankLogoId = bankLogoName?.let { activity.resources.getIdentifier(it, "drawable", activity.packageName) } ?: 0
            if (bankLogoId != 0) {
