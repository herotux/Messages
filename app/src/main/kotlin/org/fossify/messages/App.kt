...
class App : FossifyApp() {
    ...
    private val advancedSearchCallbacks = object : Application.ActivityLifecycleCallbacks {
        override fun onActivityCreated(activity: Activity, state: Bundle?) {
            ...
            activity.findViewById<android.view.View>(R.id.advanced_search_button)?.apply {
                isClickable = true
                isFocusable = true
                bringToFront()
                setOnClickListener { activity.startActivity(Intent(activity, AdvancedSearchActivity::class.java)) }
            }
        }
