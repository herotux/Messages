...
object PluginRegistry {
    ...
    val all = listOf(
        ...
        Plugin(AI_ASSISTANT, "دستیار هوش مصنوعی", "AI Assistant", "تولید، بازنویسی و پیشنهاد پاسخ برای پیامک‌ها با سرویس هوش مصنوعی", "Generate, rewrite and suggest SMS replies with an AI service")
    )
}
